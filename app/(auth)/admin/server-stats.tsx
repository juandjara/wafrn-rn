        ...
        {data && (
          <>
            <View className="p-3 bg-gray-800 mb-4">
              <Text className="text-gray-200 text-sm pb-1 mb-3 border-b border-gray-600">Server usage:</Text>
            ...
            <View className="p-3 bg-gray-800 mb-4">
              <Text className="text-gray-200 text-sm pb-1 mb-3 border-b border-gray-600">Worker queues:</Text>
              <Text className="text-white text-lg">
                <Text className="text-xl">
