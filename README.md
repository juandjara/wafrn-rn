...
| `RELEASES_URL`          | URL for checking the latest app release.                                    | F-Droid packages API (`dev.djara.wafrn_rn`)            |
...
If you want to know more about the Version Release Process, [read here](./docs/VERSION.md)
